...
const Recipes = ({ label, query }: RecipesProps) => {
  ...
  return (
    <>
      <div className="grid h-[750px] w-full items-center justify-center overflow-hidden px-2 md:h-[400px] xl:h-[440px] xl:px-3">
        <div>
          <h1 className="text-[1.25em]">{label}</h1>
        </div>
        <div className="mt-5 grid grid-cols-2 gap-5 text-center text-sm md:grid-cols-4 xl:mt-0 xl:grid-cols-6">
